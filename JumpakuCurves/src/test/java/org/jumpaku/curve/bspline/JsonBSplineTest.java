...
public class JsonBSplineTest {
    ...
    public void testFromJson(){
        ...
        BSpline actual = new JsonBSpline().fromJson(
                "{controlPoints:[{x:-2.0,y:0.0,z:0.0,r:1.0},{x:-1.0,y:1.0,z:0.0,r:2.0},{x:0.0,y:0.0,z:0.0,r:3.0},{x:1.0,y:-1.0,z:0.0,r:4.0},{x:2.0,y:0.0,z:0.0,r:5.0}], knots:[{value:0.0, multiplicity:4}, {value:1.0, multiplicity:1}, {value:2.0, multiplicity:4}]}").get();
        BSpline expected = BSpline.create(
                3,
                Stream.of(Point.fuzzy(-2.0, 0.0, 1.0), Point.fuzzy(-1.0, 1.0, 2.0), Point.fuzzy(0.0, 0.0, 3.0), Point.fuzzy(1.0, -1.0, 4.0), Point.fuzzy(2.0, 0.0, 5.0)),
                Knot.clampedUniformKnots(3, 5));
