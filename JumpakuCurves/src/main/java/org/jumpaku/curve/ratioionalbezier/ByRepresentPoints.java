...
public final class ByRepresentPoints implements FuzzyCurve, Differentiable, Reverseable<ByRepresentPoints> {
    ...
    @Override
    public ByRepresentPoints restrict(Double begin, Double end) {
        return restrict(Interval.of(begin, end));
    }

    @Override
    public ByRepresentPoints reverse() {
    ...
    public RationalBezier toCrispRationalBezier(){
        return new RationalBezier(getDomain(), createCrispControlPoints(getWeight(), getRepresentPoints()));
    }
    ...
    public String toString() {
        return JsonByRepresentPoints.CONVERTER.toJson(this);
    }

    public ByRepresentPoints complement() {
