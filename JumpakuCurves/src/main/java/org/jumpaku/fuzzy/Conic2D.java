 ...
 * @author Jumpaku
 */
public class Conic2D extends Point2D implements Membership<Conic2D, Point2D>{
    ...
    public static Boolean equals(Conic2D p1, Conic2D p2, Double eps){
        return Point.equals(p1, p2, eps) && Precision.equals(p1.getRadius(), p2.getRadius(), eps);
    }
    
    public static Boolean equals(Conic2D p1, Conic2D p2, Integer ulp){
        return Point.equals(p1, p2, ulp) && Precision.equals(p1.getRadius(), p2.getRadius(), ulp);
    }
